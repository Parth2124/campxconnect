...
SECRET_KEY = 'django-insecure-@9-gpo^$j&h#s0__1)^0(d2$4%b_i5yhw$^=#yza-e5024ab8#'
...
SECURE_SSL_REDIRECT = False  # Do NOT force HTTPS (ngrok handles it)
SECURE_HSTS_SECONDS = 0  # Disable HSTS (since it's temporary hosting)
...
USE_TZ = True  # Keep it True to use timezone-aware timestamps
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'cx.campusconnect@gmail.com'  # Replace with your email
EMAIL_HOST_PASSWORD = 'vgsc crsc gfjb yvtp'
ADMIN_EMAIL = 'cx.campusconnect@gmail.com'  # Replace with your email
